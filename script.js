document.addEventListener('DOMContentLoaded', function() {
  ...
  function openClass(course) 
  {
      ...
      if (['arithmetic', 'logical', 'editing','tactical skills'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="i2.png" class="crourseimg" alt="back1">
      ...
      if (['experimental', 'arithmetic', 'critical','mentalskills'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="h2.png" class="crourseimg" alt="back1">
      ...
      if (['design', 'analytical', 'experimental','understanding','tactical skills'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="a4.png" class="crourseimg" alt="back1">
      ...
      if (['design', 'understanding', 'experimental'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="i1.png" class="crourseimg" alt="back1">
      ...
      if (['design', 'understanding', 'experimental','critical'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="a5.png" class="crourseimg" alt="back1">
      ...
      {
          courseHTML += `<div class="dep">
          <img src="a14.png" class="crourseimg" alt="back1">
      ...
      {
          courseHTML += `<div class="dep">
          <img src="a3.png" class="crourseimg" alt="back1">
      ...
      {
          courseHTML += `<div class="dep">
          <img src="a12.png" class="crourseimg" alt="back1">
      ...
      {
          courseHTML += `<div class="dep">
          <img src="a10.png" class="crourseimg" alt="back1">
      ...
      if (['experimental','understanding','critical'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="a9.png" class="crourseimg" alt="back1">
      ...
      if (['arithmetic','design','logical'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="a8.png" class="crourseimg" alt="back1">
      ...
      if (['physical skills','mental skills'].includes(course.toLowerCase())) 
      {
          courseHTML += `<div class="dep">
          <img src="a6.png" class="crourseimg" alt="back1">
